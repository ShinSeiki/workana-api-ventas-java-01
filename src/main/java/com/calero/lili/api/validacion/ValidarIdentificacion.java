package com.calero.lili.api.validacion;
...
public class ValidarIdentificacion {
    ...
    public boolean validarCedula(String numero) throws Exception {
        try {
            ...
            validarTercerDigito(String.valueOf(numero.charAt(2)), TipoIdentificacion.getTipoCedula());
    ...
    public boolean validarRucPersonaNatural(String numero) throws Exception {
        try {
            ...
            validarCodigoProvincia(numero.substring(0, 2));
            validarTercerDigito(String.valueOf(numero.charAt(2)), TipoIdentificacion.getTipoRucNatural());
